  ...
  uk: [
    {
      ...
      metaDescription:
        "Створюю лендінги під ключ для SaaS, сервісних компаній, експертів і локального бізнесу. Швидкий запуск, сильна структура, база, готова до SEO, і висока конверсія.",
    ...
    },
    {
      ...
      keywords: [
        ...
        "розробка інтернет-магазину на Next.js",
