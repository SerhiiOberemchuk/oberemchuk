...
export default function Home() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "Терміни розробки вебсайту варіюютьс���� залежно від складності проекту. Простий лендінг може бути готовий за 1-2 тижні, корпоративний сайт - за 3-4 тижні, а складний інтернет-магазин може зайняти 1-3 місяці. Ми завжди обговорюємо терміни на початку проекту і дотримуємося узгодженого графіка.",
    },
    {
