    ...
    <div className="container mx-auto max-w-4xl py-12 md:py-24">
      <div className="space-y-8">
        ...
        <div className="prose prose-gray max-w-none">
          ...
          <p>
            Мій веб-сайт використовує різні типи cookies для різних цілей. Деякі cookies необхідні для функціонування
            сайту, інші допомагають мені покращити ваш досвід, аналізуючи, як ви використовуєте мій сайт, а треті
          ...
          <Table>
            ...
            <TableBody>
              <TableRow>
                ...
                <TableCell>
                  Ці cookies необхідні для функціонування мого веб-сайту і не можуть бути вимкнені. Вони зазвичай
              ...
              <TableRow>
                ...
                <TableCell>
                  Ці cookies дозволяють мені підраховувати відвідування і джерела трафіку, щоб я міг вимірювати і
                  покращувати продуктивність мого сайту. Вони допомагають мені дізнатися, які сторінки найбільш і
          ...
          <ul>
            <li>
              <strong>cookie-consent</strong> - Зберігає ваші налаштування щодо використання cookies на моєму сайті.
            </li>
            <li>
              <strong>session</strong> - Використовується для підтримки функціональності сайту та збереження ваших
          ...
          <p>
            Наразі мій сайт не використовує маркетингові cookies. Якщо в майбутньому я почну їх використовувати, я
            оновлю цю політику з детальною інформацією про кожен такий cookie.
          </p>

          <h2>Сторонні cookies</h2>
          <p>
            Деякі cookies встановлюються сторонніми сервісами, які відображаються на моїх сторінках. Я не контролюю
          ...
          <p>
            Мій веб-сайт використовує Google Analytics, сервіс веб-аналітики, що надається Google, Inc. Google Analytics
            використовує cookies для аналізу використання мого веб-сайту. Інформація, створена cookie про ваше
            використання мого веб-сайту (включаючи вашу IP-адресу), буде передана та збережена Google на серверах у
            Сполучених Штатах.
          </p>
          <p>
            Google використовуватиме цю інформацію з метою оцінки вашого використання мого веб-сайту, складання звітів
            про активність веб-сайту для мене та надання інших послуг, пов'язаних з активністю веб-сайту та
            використанням Інтернету. Google також може передавати цю інформацію третім особам, якщо це вимагається
            законом, або якщо такі треті особи обробляють інформацію від імені Google.
          </p>
          <p>
          ...
          <ul>
            <li>
              <strong>Через налаштування мого сайту</strong> - Ви можете в будь-який момент змінити свої налаштування
          ...
          <div className="bg-gray-50 p-6 rounded-lg mt-8 flex flex-col md:flex-row items-center justify-between gap-4">
            <div>
              ...
              <p className="text-gray-600">
                Ви можете в будь-який момент змінити свої налаштування cookies для мого сайту.
              </p>
            </div>
          ...
          <p>
            Якщо ви вирішите відключити певні cookies, деякі функції мого веб-сайту можуть не працювати належним чином.
            Наприклад, ви не зможете використовувати всі переваги веб-сайту або сервісів, які вимагають входу в систему.
          </p>
          <p>
            Відключення аналітичних cookies не вплине на вашу можливість використовувати мій веб-сайт, але це означає,
            що я не зможу отримувати інформацію про те, як ви використовуєте мій сайт, що може погіршити ваш досвід у
            довгостроковій перспективі.
          </p>

          <h2>Зміни до цієї Політики використання cookies</h2>
          <p>
            Я можу оновлювати мою Політику використання cookies час від часу. Я повідомлю вас про будь-які зміни,
            розмістивши нову Політику використання cookies на цій сторінці.
          </p>
          <p>
            Я рекомендую вам періодично переглядати цю Політику використання cookies, щоб бути в курсі будь-яких змін.
          </p>

          <h2>Зв'язок зі мною</h2>
          <p>Якщо у вас є питання щодо моєї Політики використання cookies, будь ласка, зв'яжіться зі мною:</p>
          <ul>
