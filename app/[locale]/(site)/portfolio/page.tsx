    ...
    mainEntity: {
      ...
      itemListElement: projects.map((project, index) => ({
        ...
        item: {
          ...
          url: `https://www.oberemchuk.site${isEnglish ? `/en/portfolio/${project.slug}` : `/portfolio/${project.slug}`}`,
        ...
        {projects.length > 0 ? (
          <>
            <AnimationWrapper animation="fade-in" delay={100}>
              <PortfolioShowcase projects={projects} locale={locale as "uk" | "en"} />
            </AnimationWrapper>

            <section className="mt-20" aria-labelledby="portfolio-archive-title">
              <AnimationWrapper animation="slide-up">
                <div className="mb-10 grid gap-6 border-t border-[rgba(24,31,43,0.14)] pt-8 lg:grid-cols-[0.7fr_1.3fr] lg:items-end">
                  <div>
                    ...
                    <h2 id="portfolio-archive-title" className="text-4xl text-[hsl(var(--foreground))] md:text-6xl">
                      {pageT("listLabel")}
                    </h2>
                  </div>
              ...
              <ul className="grid grid-cols-1 gap-8 md:grid-cols-2 xl:grid-cols-3" aria-label={pageT("listLabel")}>
          ...
          <div className="py-20 text-center">
            <p className="text-[hsl(var(--muted-foreground))]">{pageT("empty")}</p>
          </div>
        )}
